...
from squirrel.model import Collection, Entry, Parameter
from squirrel.widgets.core import (DataWidget, Display, NameDescTagsWidget,
                                   WindowLinker)
from squirrel.widgets.enhanced import FilterComboBox
from squirrel.widgets.manip_helpers import insert_widget
from squirrel.widgets.views import (BaseTableEntryModel, LivePVHeader,
