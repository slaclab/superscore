...
class DateRangeWidget(QtWidgets.QWidget):
    ...
    def open_calendar(self):
        ...
        try:
            ...
            pass
        self.calendar.selectionChanged.connect(lambda: target.setText(self.calendar.selectedDate().toString(self.FORMAT)))
    ...
    def emitRangeChanged(self):
        self.rangeChanged.emit(QtCore.QDate.fromString(self.since.text(), self.FORMAT), QtCore.QDate.fromString(self.until.text(), self.FORMAT))
